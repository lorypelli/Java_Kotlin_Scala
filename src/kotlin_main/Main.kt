...
fun main() {
    ...
    println(
        "Il perimetro del triangolo di lati %.2f, %.2f e %.2f è: %.2f".format(
            triangle1,
            triangle2,
            triangle3,
            Triangle(triangle1, triangle2, triangle3).p
        )
    )
    ...
    println(
        "Il perimetro del rettangolo di lati %.2f e %.2f è: %.2f".format(
            rectangle1,
            rectangle2,
            Rectangle(rectangle1, rectangle2).p
        )
    )
    ...
    println(
        "Il perimetro del trapezio di lati %.2f, %.2f, %.2f e %.2f è: %.2f".format(
            trapezium1,
            trapezium2,
            trapezium3,
            trapezium4,
            Trapezium(trapezium1, trapezium2, trapezium3, trapezium4).p
        )
    )
}
...
class Triangle(
    private val l1: Float,
    private val l2: Float,
    private val l3: Float,
    msg: String = Defaults.DEFAULT_MSG
) : Polygon(msg) {
    val p = perimeter()
